...
namespace DB_RecordDetail_DataGenerate
{
    public static class SqlServerHelper
    {
        ...
        {
            _dbProvider = System.Data.SqlClient.SqlClientFactory.Instance;
        }
        ...
        static string _ConnectionString = ConfigurationManager.ConnectionStrings["SqlServerDB"].ConnectionString;

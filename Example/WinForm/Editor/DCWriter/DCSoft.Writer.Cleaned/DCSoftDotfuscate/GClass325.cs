...
{
	[ComVisible(false)]
	public class GClass325 : GClass320
	{
		...
		public GClass325()
		{
			method_7(typeof(ShapeLinesElement));
		...
		private GEnum75 method_14()
		{
			...
			ShapeLinesElement shapeLinesElement = (ShapeLinesElement)vmethod_7();
			shapeLinesElement.Parent = method_4();
			shapeLinesElement.OwnerDocument = method_2();
			...
			shapeLinesElement.Points = array;
			method_11(shapeLinesElement);

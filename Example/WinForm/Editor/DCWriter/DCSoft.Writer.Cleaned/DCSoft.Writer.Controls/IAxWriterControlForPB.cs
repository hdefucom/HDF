...
{
	/// <summary>AxWriterControlForPB 的COM接口</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	[InterfaceType(ComInterfaceType.InterfaceIsDual)]
	[Browsable(false)]
	[Guid("2EF03C7A-528E-4FDE-BCCF-CC186D3BBFAC")]
	[ComVisible(true)]
	public interface IAxWriterControlForPB
	{
		...
		/// <summary>方法PBComGetProperty</summary>
		[DispId(3003)]
		string PBComGetProperty(ref string propertyName);

		/// <summary>方法PBComSetProperty</summary>
		[DispId(3002)]
		bool PBComSetProperty(ref string propertyName, ref string Value);

		/// <summary>方法PBCourseRecordControllerSetAttributeNameLabelIDMap</summary>
		[DispId(12963)]
		void PBCourseRecordControllerSetAttributeNameLabelIDMap(ref string attributeName, ref string labelID);

		/// <summary>方法PBExecuteCommand</summary>
		[DispId(12964)]
		object PBExecuteCommand(ref string commandName, ref bool showUI, ref object parameter);

		/// <summary>方法PBGetElementById</summary>
		[DispId(12965)]
		XTextElement PBGetElementById(ref string string_0);

		/// <summary>方法PBGetHtmlText</summary>
		[DispId(12966)]
		string PBGetHtmlText(ref bool includeSelectionOnly);

		/// <summary>方法PBGetInputFieldElementById</summary>
		[DispId(12967)]
		XTextInputFieldElement PBGetInputFieldElementById(ref string string_0);

		/// <summary>方法PBGetTableElementById</summary>
		[DispId(12968)]
		XTextTableElement PBGetTableElementById(ref string string_0);

		/// <summary>方法PBGetXMLTextForSave</summary>
		[DispId(12969)]
		string PBGetXMLTextForSave();

		/// <summary>方法PBLoadDocumentFromFile</summary>
		[DispId(3001)]
		bool PBLoadDocumentFromFile(ref string fileName, ref string format);

		/// <summary>方法PBLoadDocumentFromString</summary>
		[DispId(12970)]
		bool PBLoadDocumentFromString(ref string text, ref string format);

		/// <summary>方法PBSetDocumentScriptText</summary>
		[DispId(12971)]
		void PBSetDocumentScriptText(ref string script);

		/// <summary>方法PBSetElementChecked</summary>
		[DispId(12972)]
		bool PBSetElementChecked(ref string string_0, ref bool bool_0);

...
namespace CSDeskBand
{
    ...
    internal sealed class CSDeskBandImpl : ICSDeskBand
    {
        ...
        {
            var commandInfo = Marshal.PtrToStructure(pici, typeof(CMINVOKECOMMANDINFO)) as CMINVOKECOMMANDINFO;
...
#pragma warning restore CS0219 // Variable is assigned but its value is never used
            ...
            if (commandInfo.cbSize == Marshal.SizeOf(typeof(CMINVOKECOMMANDINFOEX)))
            {
                isExtended = true;

                var extended = (CMINVOKECOMMANDINFOEX)Marshal.PtrToStructure(pici, typeof(CMINVOKECOMMANDINFOEX));
    ...
    public sealed class CSDeskBandOptions : INotifyPropertyChanged
    {
        ...
        public bool HeightCanChange
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(HeightCanChange));
            }
        }
        ...
        public int HeightIncrement
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(HeightIncrement));
            }
        }
        ...
        public DeskBandSize MinVerticalSize
        {
            ...
            set
            {
                ...
                _minVerticalSize.PropertyChanged += (sender, args) => OnPropertyChanged(nameof(MinVerticalSize));
                OnPropertyChanged(nameof(MinVerticalSize));
            }
        }
        ...
        public int MaxVerticalWidth
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(MaxVerticalWidth));
            }
        }
        ...
        public DeskBandSize VerticalSize
        {
            ...
            set
            {
                ...
                _verticalSize = value;
                _verticalSize.PropertyChanged += (sender, args) => OnPropertyChanged(nameof(VerticalSize));
                OnPropertyChanged(nameof(VerticalSize));
            }
        }
        ...
        public DeskBandSize MinHorizontalSize
        {
            ...
            set
            {
                ...
                _minHorizontalSize.PropertyChanged += (sender, args) => OnPropertyChanged(nameof(MinHorizontalSize));
                OnPropertyChanged(nameof(MinHorizontalSize));
            }
        }
        ...
        public int MaxHorizontalHeight
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(MaxHorizontalHeight));
            }
        }
        ...
        public DeskBandSize HorizontalSize
        {
            ...
            set
            {
                ...
                _horizontalSize.PropertyChanged += (sender, args) =>  OnPropertyChanged(nameof(HorizontalSize));
                OnPropertyChanged(nameof(HorizontalSize));
            }
        }
...
namespace CSDeskBand
{
    ...
    internal static class RegistrationHelper
    {
        ...
        {
            return (Attribute.GetCustomAttribute(t, typeof(CSDeskBandRegistrationAttribute)) as CSDeskBandRegistrationAttribute)?.Name;
        }
        ...
        {
            return (Attribute.GetCustomAttribute(t, typeof(CSDeskBandRegistrationAttribute)) as CSDeskBandRegistrationAttribute)?.ShowDeskBand ?? false;
        }
    }
}
namespace CSDeskBand

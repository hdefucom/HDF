...
{
	                                                                    /// <summary>
	                                                                    ///       FoxBase的DBF数据库文件的数据读取器
	                                                                    ///       </summary>
	[ComVisible(false)]
	public class DBaseFoxBaseFileReader : DBaseFileReader
	{
		public DBaseFoxBaseFileReader(string strFileName)
			: base(strFileName)
		{
		}

		public DBaseFoxBaseFileReader(Stream stream)
			: base(stream)
		{
		}

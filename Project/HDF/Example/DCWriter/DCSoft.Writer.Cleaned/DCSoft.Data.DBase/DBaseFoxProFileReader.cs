...
{
	                                                                    /// <summary>
	                                                                    ///       FoxPro的DBF数据库文件的数据读取器
	                                                                    ///       </summary>
	[ComVisible(false)]
	public class DBaseFoxProFileReader : DBaseFileReader
	{
		public DBaseFoxProFileReader(string strFileName)
			: base(strFileName)
		{
		}

		public DBaseFoxProFileReader(Stream stream)
			: base(stream)
		{
		}

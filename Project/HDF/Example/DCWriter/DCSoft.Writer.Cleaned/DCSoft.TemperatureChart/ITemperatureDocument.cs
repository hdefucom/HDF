...
{
	/// <summary>TemperatureDocument 的COM接口</summary>
	[ComVisible(true)]
	[EditorBrowsable(EditorBrowsableState.Never)]
	[Browsable(false)]
	[InterfaceType(ComInterfaceType.InterfaceIsDual)]
	[Guid("E7553B89-F8F2-484E-98EE-1C527A46A4C5")]
	public interface ITemperatureDocument
	{
		...
		[DispId(41)]
		TemperatureDocumentConfig Config
		{
			get;
			set;
		}
		...
		[DispId(10)]
		HeaderLabelInfoList HeaderLabels
		{
			get;
			set;
		}
		...
		/// <summary>属性NumOfDaysInOnePage</summary>
		[DispId(16)]
		int NumOfDaysInOnePage
		{
			get;
			set;
		}

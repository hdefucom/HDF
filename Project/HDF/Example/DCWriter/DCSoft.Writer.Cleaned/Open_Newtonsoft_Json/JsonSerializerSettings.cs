...
{
	/// <summary>
	///       Specifies the settings on a <see cref="T:Open_Newtonsoft_Json.JsonSerializer" /> object.
	///       </summary>
	[ComVisible(false)]
	public class JsonSerializerSettings
	{
		...
		/// <summary>
		///       Gets or sets a collection <see cref="T:Open_Newtonsoft_Json.JsonConverter" /> that will be used during serialization.
		///       </summary>
		...
		/// <summary>
		///       Gets or sets a function that creates the <see cref="T:Open_Newtonsoft_Json.Serialization.IReferenceResolver" /> used by the serializer when resolving references.
		///       </summary>
		/// <value>A function that creates the <see cref="T:Open_Newtonsoft_Json.Serialization.IReferenceResolver" /> used by the serializer when resolving references.</value>
		...
		/// <summary>
		///       Initializes a new instance of the <see cref="T:Open_Newtonsoft_Json.JsonSerializerSettings" /> class.
		///       </summary>

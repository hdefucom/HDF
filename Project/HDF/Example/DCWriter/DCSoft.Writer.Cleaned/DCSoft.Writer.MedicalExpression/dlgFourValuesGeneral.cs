...
namespace DCSoft.Writer.MedicalExpression
{
	...
	///       </summary>
	[ComVisible(false)]
	public class dlgFourValuesGeneral : Form
	{
		...
		private void dlgFourValuesGeneral_Load(object sender, EventArgs e)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.Writer.MedicalExpression.dlgFourValuesGeneral));
			...
			base.Name = "dlgFourValuesGeneral";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.Load += new System.EventHandler(dlgFourValuesGeneral_Load);
			ResumeLayout(false);
			PerformLayout();
		}
	}

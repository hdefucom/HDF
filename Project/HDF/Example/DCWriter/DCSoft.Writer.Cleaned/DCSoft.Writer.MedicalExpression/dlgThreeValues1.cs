...
namespace DCSoft.Writer.MedicalExpression
{
	...
	public class dlgThreeValues1 : Form
	{
		...
		private void dlgThreeValues1_Load(object sender, EventArgs e)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.Writer.MedicalExpression.dlgThreeValues1));
			...
			base.Load += new System.EventHandler(dlgThreeValues1_Load);
			ResumeLayout(false);
			PerformLayout();
		}
	}

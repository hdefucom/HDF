...
namespace DCSoft.Writer.MedicalExpression
{
	...
	public class dlgPermanentTeethBitmap : Form
	{
		...
		private Label textBox27;

		private Label textBox28;

		private Label textBox29;

		private Label textBox30;

		private Label textBox31;

		private Label textBox32;
		...
		private Label textBox32P;

		private Label textBox32L;

		private Label textBox32B;

		private Label textBox32D;

		private Label textBox32O;

		private Label textBox32M;

		private Label textBox31P;

		private Label textBox31L;

		private Label textBox31B;

		private Label textBox31D;

		private Label textBox31O;

		private Label textBox31M;

		private Label textBox30P;

		private Label textBox30L;

		private Label textBox30B;

		private Label textBox30D;

		private Label textBox30O;

		private Label textBox30M;

		private Label textBox29P;

		private Label textBox29L;

		private Label textBox29B;

		private Label textBox29D;

		private Label textBox29O;

		private Label textBox29M;

		private Label textBox28P;

		private Label textBox28L;

		private Label textBox28B;

		private Label textBox28D;

		private Label textBox28O;

		private Label textBox28M;

		private Label textBox27P;

		private Label textBox27L;

		private Label textBox27B;

		private Label textBox27D;

		private Label textBox27O;

		private Label textBox27M;

		private Label textBox26P;

		private Label textBox26L;

		private Label textBox26B;

		private Label textBox26D;

		private Label textBox26O;

		private Label textBox26M;

		private Label textBox25P;

		private Label textBox25L;

		private Label textBox25B;

		private Label textBox25D;

		private Label textBox25O;

		private Label textBox25M;

		private Label textBox24P;

		private Label textBox24L;

		private Label textBox24B;

		private Label textBox24D;

		private Label textBox24O;

		private Label textBox24M;

		private Label textBox23P;

		private Label textBox23L;

		private Label textBox23B;

		private Label textBox23D;

		private Label textBox23O;

		private Label textBox23M;

		private Label textBox22P;

		private Label textBox22L;

		private Label textBox22B;

		private Label textBox22D;

		private Label textBox22O;

		private Label textBox22M;

		private Label textBox21P;

		private Label textBox21L;

		private Label textBox21B;

		private Label textBox21D;

		private Label textBox21O;

		private Label textBox21M;
		...
		private void method_0(object sender, MouseEventArgs e)
		{
			...
			if (e.Button == MouseButtons.Left && (label.BackColor == SystemColors.ControlLightLight || label.BackColor == SystemColors.GradientInactiveCaption))
			{
				...
				{
					method_3("textBox" + text.ToString(), bool_0: true);
				}
			...
			{
				label.BackColor = method_4(name);
				method_1(text, bool_0: false);
				if (!name.EndsWith("M") && !name.EndsWith("O") && !name.EndsWith("D") && !name.EndsWith("B") && !name.EndsWith("L") && !name.EndsWith("P"))
				{
					method_3(name + "M", bool_0: false);
					method_3(name + "O", bool_0: false);
					method_3(name + "D", bool_0: false);
					method_3(name + "B", bool_0: false);
					method_3(name + "L", bool_0: false);
					method_3(name + "P", bool_0: false);
				}
			}
		}
		...
		private void method_1(string string_0, bool bool_0)
		{
			...
			string text = method_6(int_);
			if (bool_0)
			{
				medicalExpressionValueList_0.SetValue("Value" + int_, text.ToString());
			}
			else
			{
		...
		private void method_2()
		{
			...
			for (int i = 1; i <= 32; i++)
			{
				...
				if (!string.IsNullOrEmpty(value))
				{
					...
					method_3("textBox" + i, bool_0: true);
					for (int j = 0; j < array.Length; j++)
					{
						method_3("textBox" + i + array[j], bool_0: true);
					}
				}
			}
		}
		...
		private void method_3(string string_0, bool bool_0)
		{
			foreach (Control control in base.Controls)
			{
				if (control.Name == string_0)
				{
					...
					{
						control.BackColor = method_4(control.Name);
					}
				}
			}
		}

		private Color method_4(string string_0)
		{
			int num = 2;
			string text = "";
		...
		private string method_6(int int_0)
		{
			...
			else if (int_0 > 8 && int_0 < 17)
			{
				num2 = int_0 - 8;
			}
			else if (int_0 > 16 && int_0 < 25)
			{
				num2 = 25 - int_0;
			}
			else if (int_0 > 24 && int_0 < 33)
			{
				num2 = int_0 - 24;
			}
			empty = num2.ToString();
		...
		private void dlgPermanentTeethBitmap_Load(object sender, EventArgs e)
		{
			method_7();
			method_2();
		}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.Writer.MedicalExpression.dlgPermanentTeethBitmap));
			...
			textBox21 = new System.Windows.Forms.Label();
			textBox22 = new System.Windows.Forms.Label();
			textBox23 = new System.Windows.Forms.Label();
			textBox24 = new System.Windows.Forms.Label();
			textBox25 = new System.Windows.Forms.Label();
			textBox26 = new System.Windows.Forms.Label();
			textBox27 = new System.Windows.Forms.Label();
			textBox28 = new System.Windows.Forms.Label();
			textBox29 = new System.Windows.Forms.Label();
			textBox30 = new System.Windows.Forms.Label();
			textBox31 = new System.Windows.Forms.Label();
			textBox32 = new System.Windows.Forms.Label();
			...
			textBox32P = new System.Windows.Forms.Label();
			textBox32L = new System.Windows.Forms.Label();
			textBox32B = new System.Windows.Forms.Label();
			textBox32D = new System.Windows.Forms.Label();
			textBox32O = new System.Windows.Forms.Label();
			textBox32M = new System.Windows.Forms.Label();
			textBox31P = new System.Windows.Forms.Label();
			textBox31L = new System.Windows.Forms.Label();
			textBox31B = new System.Windows.Forms.Label();
			textBox31D = new System.Windows.Forms.Label();
			textBox31O = new System.Windows.Forms.Label();
			textBox31M = new System.Windows.Forms.Label();
			textBox30P = new System.Windows.Forms.Label();
			textBox30L = new System.Windows.Forms.Label();
			textBox30B = new System.Windows.Forms.Label();
			textBox30D = new System.Windows.Forms.Label();
			textBox30O = new System.Windows.Forms.Label();
			textBox30M = new System.Windows.Forms.Label();
			textBox29P = new System.Windows.Forms.Label();
			textBox29L = new System.Windows.Forms.Label();
			textBox29B = new System.Windows.Forms.Label();
			textBox29D = new System.Windows.Forms.Label();
			textBox29O = new System.Windows.Forms.Label();
			textBox29M = new System.Windows.Forms.Label();
			textBox28P = new System.Windows.Forms.Label();
			textBox28L = new System.Windows.Forms.Label();
			textBox28B = new System.Windows.Forms.Label();
			textBox28D = new System.Windows.Forms.Label();
			textBox28O = new System.Windows.Forms.Label();
			textBox28M = new System.Windows.Forms.Label();
			textBox27P = new System.Windows.Forms.Label();
			textBox27L = new System.Windows.Forms.Label();
			textBox27B = new System.Windows.Forms.Label();
			textBox27D = new System.Windows.Forms.Label();
			textBox27O = new System.Windows.Forms.Label();
			textBox27M = new System.Windows.Forms.Label();
			textBox26P = new System.Windows.Forms.Label();
			textBox26L = new System.Windows.Forms.Label();
			textBox26B = new System.Windows.Forms.Label();
			textBox26D = new System.Windows.Forms.Label();
			textBox26O = new System.Windows.Forms.Label();
			textBox26M = new System.Windows.Forms.Label();
			textBox25P = new System.Windows.Forms.Label();
			textBox25L = new System.Windows.Forms.Label();
			textBox25B = new System.Windows.Forms.Label();
			textBox25D = new System.Windows.Forms.Label();
			textBox25O = new System.Windows.Forms.Label();
			textBox25M = new System.Windows.Forms.Label();
			textBox24P = new System.Windows.Forms.Label();
			textBox24L = new System.Windows.Forms.Label();
			textBox24B = new System.Windows.Forms.Label();
			textBox24D = new System.Windows.Forms.Label();
			textBox24O = new System.Windows.Forms.Label();
			textBox24M = new System.Windows.Forms.Label();
			textBox23P = new System.Windows.Forms.Label();
			textBox23L = new System.Windows.Forms.Label();
			textBox23B = new System.Windows.Forms.Label();
			textBox23D = new System.Windows.Forms.Label();
			textBox23O = new System.Windows.Forms.Label();
			textBox23M = new System.Windows.Forms.Label();
			textBox22P = new System.Windows.Forms.Label();
			textBox22L = new System.Windows.Forms.Label();
			textBox22B = new System.Windows.Forms.Label();
			textBox22D = new System.Windows.Forms.Label();
			textBox22O = new System.Windows.Forms.Label();
			textBox22M = new System.Windows.Forms.Label();
			textBox21P = new System.Windows.Forms.Label();
			textBox21L = new System.Windows.Forms.Label();
			textBox21B = new System.Windows.Forms.Label();
			textBox21D = new System.Windows.Forms.Label();
			textBox21O = new System.Windows.Forms.Label();
			textBox21M = new System.Windows.Forms.Label();
			...
			richTextBox17 = new System.Windows.Forms.RichTextBox();
			richTextBox18 = new System.Windows.Forms.RichTextBox();
			SuspendLayout();
			...
			textBox6M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox6O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox6D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox6B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox6L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox6P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox7M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox7O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox7D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox7B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox7L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox7P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox8M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox8O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox8D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox8B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox8L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox8P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox11M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox11O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox11D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox11B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox11L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox11P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox12M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox12O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox12D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox12B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox12L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox12P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox13M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox13O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox13D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox13B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox13L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox13P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox14M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox14O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox14D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox14B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox14L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox14P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox15M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox15O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox15D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox15B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox15L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox15P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox32P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox32P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox32P, "textBox32P");
			textBox32P.Name = "textBox32P";
			textBox32L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox32L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox32L, "textBox32L");
			textBox32L.Name = "textBox32L";
			textBox32B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox32B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox32B, "textBox32B");
			textBox32B.Name = "textBox32B";
			textBox32D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox32D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox32D, "textBox32D");
			textBox32D.Name = "textBox32D";
			textBox32O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox32O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox32O, "textBox32O");
			textBox32O.Name = "textBox32O";
			textBox32M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox32M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox32M, "textBox32M");
			textBox32M.Name = "textBox32M";
			textBox31P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox31P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox31P, "textBox31P");
			textBox31P.Name = "textBox31P";
			textBox31L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox31L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox31L, "textBox31L");
			textBox31L.Name = "textBox31L";
			textBox31B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox31B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox31B, "textBox31B");
			textBox31B.Name = "textBox31B";
			textBox31D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox31D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox31D, "textBox31D");
			textBox31D.Name = "textBox31D";
			textBox31O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox31O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox31O, "textBox31O");
			textBox31O.Name = "textBox31O";
			textBox31M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox31M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox31M, "textBox31M");
			textBox31M.Name = "textBox31M";
			textBox30P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox30P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox30P, "textBox30P");
			textBox30P.Name = "textBox30P";
			textBox30L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox30L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox30L, "textBox30L");
			textBox30L.Name = "textBox30L";
			textBox30B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox30B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox30B, "textBox30B");
			textBox30B.Name = "textBox30B";
			textBox30D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox30D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox30D, "textBox30D");
			textBox30D.Name = "textBox30D";
			textBox30O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox30O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox30O, "textBox30O");
			textBox30O.Name = "textBox30O";
			textBox30M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox30M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox30M, "textBox30M");
			textBox30M.Name = "textBox30M";
			textBox29P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox29P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox29P, "textBox29P");
			textBox29P.Name = "textBox29P";
			textBox29L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox29L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox29L, "textBox29L");
			textBox29L.Name = "textBox29L";
			textBox29B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox29B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox29B, "textBox29B");
			textBox29B.Name = "textBox29B";
			textBox29D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox29D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox29D, "textBox29D");
			textBox29D.Name = "textBox29D";
			textBox29O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox29O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox29O, "textBox29O");
			textBox29O.Name = "textBox29O";
			textBox29M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox29M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox29M, "textBox29M");
			textBox29M.Name = "textBox29M";
			textBox28P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox28P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox28P, "textBox28P");
			textBox28P.Name = "textBox28P";
			textBox28L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox28L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox28L, "textBox28L");
			textBox28L.Name = "textBox28L";
			textBox28B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox28B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox28B, "textBox28B");
			textBox28B.Name = "textBox28B";
			textBox28D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox28D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox28D, "textBox28D");
			textBox28D.Name = "textBox28D";
			textBox28O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox28O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox28O, "textBox28O");
			textBox28O.Name = "textBox28O";
			textBox28M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox28M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox28M, "textBox28M");
			textBox28M.Name = "textBox28M";
			textBox27P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox27P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox27P, "textBox27P");
			textBox27P.Name = "textBox27P";
			textBox27L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox27L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox27L, "textBox27L");
			textBox27L.Name = "textBox27L";
			textBox27B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox27B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox27B, "textBox27B");
			textBox27B.Name = "textBox27B";
			textBox27D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox27D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox27D, "textBox27D");
			textBox27D.Name = "textBox27D";
			textBox27O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox27O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox27O, "textBox27O");
			textBox27O.Name = "textBox27O";
			textBox27M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox27M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox27M, "textBox27M");
			textBox27M.Name = "textBox27M";
			textBox26P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox26P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox26P, "textBox26P");
			textBox26P.Name = "textBox26P";
			textBox26L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox26L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox26L, "textBox26L");
			textBox26L.Name = "textBox26L";
			textBox26B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox26B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox26B, "textBox26B");
			textBox26B.Name = "textBox26B";
			textBox26D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox26D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox26D, "textBox26D");
			textBox26D.Name = "textBox26D";
			textBox26O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox26O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox26O, "textBox26O");
			textBox26O.Name = "textBox26O";
			textBox26M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox26M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox26M, "textBox26M");
			textBox26M.Name = "textBox26M";
			textBox25P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox25P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox25P, "textBox25P");
			textBox25P.Name = "textBox25P";
			textBox25L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox25L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox25L, "textBox25L");
			textBox25L.Name = "textBox25L";
			textBox25B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox25B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox25B, "textBox25B");
			textBox25B.Name = "textBox25B";
			textBox25D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox25D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox25D, "textBox25D");
			textBox25D.Name = "textBox25D";
			textBox25O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox25O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox25O, "textBox25O");
			textBox25O.Name = "textBox25O";
			textBox25M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox25M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox25M, "textBox25M");
			textBox25M.Name = "textBox25M";
			textBox24P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox24P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox24P, "textBox24P");
			textBox24P.Name = "textBox24P";
			textBox24L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox24L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox24L, "textBox24L");
			textBox24L.Name = "textBox24L";
			textBox24B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox24B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox24B, "textBox24B");
			textBox24B.Name = "textBox24B";
			textBox24D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox24D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox24D, "textBox24D");
			textBox24D.Name = "textBox24D";
			textBox24O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox24O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox24O, "textBox24O");
			textBox24O.Name = "textBox24O";
			textBox24M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox24M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox24M, "textBox24M");
			textBox24M.Name = "textBox24M";
			textBox23P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox23P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox23P, "textBox23P");
			textBox23P.Name = "textBox23P";
			textBox23L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox23L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox23L, "textBox23L");
			textBox23L.Name = "textBox23L";
			textBox23B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox23B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox23B, "textBox23B");
			textBox23B.Name = "textBox23B";
			textBox23D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox23D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox23D, "textBox23D");
			textBox23D.Name = "textBox23D";
			textBox23O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox23O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox23O, "textBox23O");
			textBox23O.Name = "textBox23O";
			textBox23M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox23M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox23M, "textBox23M");
			textBox23M.Name = "textBox23M";
			textBox22P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox22P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox22P, "textBox22P");
			textBox22P.Name = "textBox22P";
			textBox22L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox22L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox22L, "textBox22L");
			textBox22L.Name = "textBox22L";
			textBox22B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox22B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox22B, "textBox22B");
			textBox22B.Name = "textBox22B";
			textBox22D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox22D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox22D, "textBox22D");
			textBox22D.Name = "textBox22D";
			textBox22O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox22O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox22O, "textBox22O");
			textBox22O.Name = "textBox22O";
			textBox22M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			textBox22M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox22M, "textBox22M");
			textBox22M.Name = "textBox22M";
			textBox21P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox21P.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox21P, "textBox21P");
			textBox21P.Name = "textBox21P";
			textBox21L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox21L.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox21L, "textBox21L");
			textBox21L.Name = "textBox21L";
			textBox21B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox21B.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox21B, "textBox21B");
			textBox21B.Name = "textBox21B";
			textBox21D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox21D.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox21D, "textBox21D");
			textBox21D.Name = "textBox21D";
			textBox21O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox21O.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox21O, "textBox21O");
			textBox21O.Name = "textBox21O";
			textBox21M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			textBox21M.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(textBox21M, "textBox21M");
			textBox21M.Name = "textBox21M";
			textBox20P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox20L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox20B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox20D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox20O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox20M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox19P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox19L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox19B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox19D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox19O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox19M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox18P.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox18L.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox18B.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox18D.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox18O.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox18M.BackColor = System.Drawing.SystemColors.GradientInactiveCaption;
			...
			textBox17P.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox17L.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox17B.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox17D.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox17O.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			textBox17M.BackColor = System.Drawing.SystemColors.ControlLightLight;
			...
			richTextBox17.BackColor = System.Drawing.SystemColors.Control;
			richTextBox17.BorderStyle = System.Windows.Forms.BorderStyle.None;
			richTextBox17.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(richTextBox17, "richTextBox17");
			richTextBox17.Name = "richTextBox17";
			richTextBox17.ReadOnly = true;
			richTextBox18.BackColor = System.Drawing.SystemColors.Control;
			richTextBox18.BorderStyle = System.Windows.Forms.BorderStyle.None;
			richTextBox18.ForeColor = System.Drawing.SystemColors.ControlText;
			resources.ApplyResources(richTextBox18, "richTextBox18");
			richTextBox18.Name = "richTextBox18";
			richTextBox18.ReadOnly = true;
			resources.ApplyResources(this, "$this");
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			base.CancelButton = btnCancel;
			base.Controls.Add(richTextBox18);
			base.Controls.Add(richTextBox17);
			base.Controls.Add(textBox32P);
			base.Controls.Add(textBox32L);
			base.Controls.Add(textBox32B);
			base.Controls.Add(textBox32D);
			base.Controls.Add(textBox32O);
			base.Controls.Add(textBox32M);
			base.Controls.Add(textBox31P);
			base.Controls.Add(textBox31L);
			base.Controls.Add(textBox31B);
			base.Controls.Add(textBox31D);
			base.Controls.Add(textBox31O);
			base.Controls.Add(textBox31M);
			base.Controls.Add(textBox30P);
			base.Controls.Add(textBox30L);
			base.Controls.Add(textBox30B);
			base.Controls.Add(textBox30D);
			base.Controls.Add(textBox30O);
			base.Controls.Add(textBox30M);
			base.Controls.Add(textBox29P);
			base.Controls.Add(textBox29L);
			base.Controls.Add(textBox29B);
			base.Controls.Add(textBox29D);
			base.Controls.Add(textBox29O);
			base.Controls.Add(textBox29M);
			base.Controls.Add(textBox28P);
			base.Controls.Add(textBox28L);
			base.Controls.Add(textBox28B);
			base.Controls.Add(textBox28D);
			base.Controls.Add(textBox28O);
			base.Controls.Add(textBox28M);
			base.Controls.Add(textBox27P);
			base.Controls.Add(textBox27L);
			base.Controls.Add(textBox27B);
			base.Controls.Add(textBox27D);
			base.Controls.Add(textBox27O);
			base.Controls.Add(textBox27M);
			base.Controls.Add(textBox26P);
			base.Controls.Add(textBox26L);
			base.Controls.Add(textBox26B);
			base.Controls.Add(textBox26D);
			base.Controls.Add(textBox26O);
			base.Controls.Add(textBox26M);
			base.Controls.Add(textBox25P);
			base.Controls.Add(textBox25L);
			base.Controls.Add(textBox25B);
			base.Controls.Add(textBox25D);
			base.Controls.Add(textBox25O);
			base.Controls.Add(textBox25M);
			base.Controls.Add(textBox24P);
			base.Controls.Add(textBox24L);
			base.Controls.Add(textBox24B);
			base.Controls.Add(textBox24D);
			base.Controls.Add(textBox24O);
			base.Controls.Add(textBox24M);
			base.Controls.Add(textBox23P);
			base.Controls.Add(textBox23L);
			base.Controls.Add(textBox23B);
			base.Controls.Add(textBox23D);
			base.Controls.Add(textBox23O);
			base.Controls.Add(textBox23M);
			base.Controls.Add(textBox22P);
			base.Controls.Add(textBox22L);
			base.Controls.Add(textBox22B);
			base.Controls.Add(textBox22D);
			base.Controls.Add(textBox22O);
			base.Controls.Add(textBox22M);
			base.Controls.Add(textBox21P);
			base.Controls.Add(textBox21L);
			base.Controls.Add(textBox21B);
			base.Controls.Add(textBox21D);
			base.Controls.Add(textBox21O);
			base.Controls.Add(textBox21M);
			...
			base.Load += new System.EventHandler(dlgPermanentTeethBitmap_Load);
			ResumeLayout(false);
			PerformLayout();
		}
	}

...
namespace DCSoft.Writer.MedicalExpression
{
	...
	public class dlgFourValues1 : Form
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.Writer.MedicalExpression.dlgFourValues1));
			...
			base.Load += new System.EventHandler(dlgFourValues1_Load);
			ResumeLayout(false);
			PerformLayout();
		}
		...
		private void dlgFourValues1_Load(object sender, EventArgs e)
		{

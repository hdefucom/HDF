...
namespace DCSoft.Writer.MedicalExpression
{
	...
	public class dlgFourValues3 : Form
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.Writer.MedicalExpression.dlgFourValues3));
			...
			base.Load += new System.EventHandler(dlgFourValues3_Load);
			ResumeLayout(false);
			PerformLayout();
		}
		...
		{
			int num = 11;
			string value = medicalExpressionValueList_0.GetValue("Value1");
			...
			txtValue2.Text = medicalExpressionValueList_0.GetValue("Value2");
			txtValue3.Text = medicalExpressionValueList_0.GetValue("Value3");
			string value2 = medicalExpressionValueList_0.GetValue("Value4");
			DateTime result2 = default(DateTime);
			if (DateTime.TryParse(value2.ToString(), out result2))
			{
				txtValue4.Value = result2;
				checkBox2.Checked = true;
			}
			else
			{
		...
		private void method_1()
		{
			...
			if (checkBox1.Checked)
			{
				medicalExpressionValueList_0.SetValue("Value1", txtValue1.Value.ToShortDateString());
			}
			else
			{
				medicalExpressionValueList_0.SetValue("Value1", textBox1.Text);
			}
			medicalExpressionValueList_0.SetValue("Value2", txtValue2.Text);
			medicalExpressionValueList_0.SetValue("Value3", txtValue3.Text);
			if (checkBox2.Checked)
			{
				medicalExpressionValueList_0.SetValue("Value4", txtValue4.Value.ToShortDateString());
			}
			else
			{
				medicalExpressionValueList_0.SetValue("Value4", textBox2.Text);
			}
		}

		private void dlgFourValues3_Load(object sender, EventArgs e)
		{
			method_0();
		}
	}

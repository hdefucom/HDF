...
namespace DCSoft.Writer.MedicalExpression
{
	...
	///       </summary>
	[ComVisible(false)]
	public class dlgDiseasedTeethBottom : Form
	{
		...
		private void dlgDiseasedTeethBottom_Load(object sender, EventArgs e)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.Writer.MedicalExpression.dlgDiseasedTeethBottom));
			...
			txtValue3.KeyPress += new System.Windows.Forms.KeyPressEventHandler(txtValue2_KeyPress);
			resources.ApplyResources(txtValue2, "txtValue2");
			txtValue2.Name = "txtValue2";
			txtValue2.KeyPress += new System.Windows.Forms.KeyPressEventHandler(txtValue2_KeyPress);
			...
			base.Name = "dlgDiseasedTeethBottom";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.Load += new System.EventHandler(dlgDiseasedTeethBottom_Load);
			ResumeLayout(false);
			PerformLayout();
		}
	}

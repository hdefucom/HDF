...
{
	/// <summary>AxWriterControl 事件的COM接口</summary>
	[EditorBrowsable(EditorBrowsableState.Never)]
	[Guid("2638F759-6C8F-4758-8A5C-D0436A76E4FC")]
	[Browsable(false)]
	[ComVisible(true)]
	[InterfaceType(ComInterfaceType.InterfaceIsIDispatch)]
	public interface IAxWriterControlComEvents
	{
		...
		/// <summary> AfterRefreshPages 事件</summary>
		[DispId(12971)]
		void AfterRefreshPages([MarshalAs(UnmanagedType.AsAny)] object sender, WriterEventArgs e);
		...
		/// <summary> DocumentPrinted 事件</summary>
		[DispId(12972)]
		void DocumentPrinted([MarshalAs(UnmanagedType.AsAny)] object sender, WriterDocumentPrintedEventArgs e);
		...
		/// <summary> EventAfterExecuteEventExpression 事件</summary>
		[DispId(12973)]
		void EventAfterExecuteEventExpression([MarshalAs(UnmanagedType.AsAny)] object sender, WriterAfterExecuteEventExpressionEventArgs e);

...
{
	[ComVisible(false)]
	public class dlgDCGridLineInfoForPageSettings : Form
	{
		...
		private NumericUpDown txtGridNumInOnePage;
		...
		public dlgDCGridLineInfoForPageSettings()
		{
			InitializeComponent();
			base.DialogResult = DialogResult.Cancel;
		}

		private void dlgDCGridLineInfoForPageSettings_Load(object sender, EventArgs e)
		{
			...
			txtGridNumInOnePage.Value = dcgridLineInfo_0.GridNumInOnePage;
		...
		private void btnOK_Click(object sender, EventArgs e)
		{
			...
			dcgridLineInfo_0.GridNumInOnePage = (int)txtGridNumInOnePage.Value;
			dcgridLineInfo_0.GridSpanInCM = 0f;
		...
		private void InitializeComponent()
		{
			...
			txtGridNumInOnePage = new System.Windows.Forms.NumericUpDown();
			label3 = new System.Windows.Forms.Label();
			chkAlignToGrid = new System.Windows.Forms.CheckBox();
			label2 = new System.Windows.Forms.Label();
			label1 = new System.Windows.Forms.Label();
			pnlGridLine.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)txtGridNumInOnePage).BeginInit();
			SuspendLayout();
			...
			pnlGridLine.Controls.Add(txtGridNumInOnePage);
			...
			txtGridNumInOnePage.Location = new System.Drawing.Point(127, 90);
			txtGridNumInOnePage.Name = "txtGridNumInOnePage";
			txtGridNumInOnePage.Size = new System.Drawing.Size(109, 21);
			txtGridNumInOnePage.TabIndex = 5;
			...
			base.Name = "dlgDCGridLineInfoForPageSettings";
			base.ShowInTaskbar = false;
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "网格线设置";
			base.Load += new System.EventHandler(dlgDCGridLineInfoForPageSettings_Load);
			pnlGridLine.ResumeLayout(false);
			pnlGridLine.PerformLayout();
			((System.ComponentModel.ISupportInitialize)txtGridNumInOnePage).EndInit();
			ResumeLayout(false);
			PerformLayout();
		}
	}

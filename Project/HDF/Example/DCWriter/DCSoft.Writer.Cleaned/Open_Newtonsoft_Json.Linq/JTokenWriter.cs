...
namespace Open_Newtonsoft_Json.Linq
{
	...
	public class JTokenWriter : JsonWriter
	{
		...
		/// <summary>
		///       Gets the <see cref="T:Open_Newtonsoft_Json.Linq.JToken" /> at the writer's current position.
		///       </summary>
		...
		/// <summary>
		///       Initializes a new instance of the <see cref="T:Open_Newtonsoft_Json.Linq.JTokenWriter" /> class writing to the given <see cref="T:Open_Newtonsoft_Json.Linq.JContainer" />.
		///       </summary>
		...
		/// <summary>
		///       Initializes a new instance of the <see cref="T:Open_Newtonsoft_Json.Linq.JTokenWriter" /> class.
		///       </summary>
		public JTokenWriter()
		{
		}

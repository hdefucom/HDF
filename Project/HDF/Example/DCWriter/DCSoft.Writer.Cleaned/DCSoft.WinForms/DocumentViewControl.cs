...
namespace DCSoft.WinForms
{
    ...
    public class DocumentViewControl : BorderUserControl
    {
                ...
                case ScrollToViewStyle.Normal:
                    {
                        ...
                        if (!rectangle.IsEmpty)
                        {
                            return method_33(rectangle.Left, rectangle.Top, rectangle.Width, rectangle.Height);
                        }
                        return false;
                    }
        ...
        public bool method_32(int int_2, int int_3, int int_4, int int_5, ScrollToViewStyle scrollToViewStyle_0)
        {
            ...
            {
                case ScrollToViewStyle.Normal:
                    return method_33(int_2, int_3, int_4, int_5);
                case ScrollToViewStyle.Top:
                    {
                        int x = int_2;
                        int y = int_3;
        ...
        protected bool method_33(int int_2, int int_3, int int_4, int int_5)
        {
            ...
            if (int_4 >= 0 && int_5 >= 0)
            {
                int num = 0;
                int num2 = 0;
                Point point = new Point(int_2, int_3);
                Rectangle clientRectangle = base.ClientRectangle;
                ...
                if (point.X > clientRectangle.Right - int_4 + 3 && clientRectangle.Right - int_4 + 3 > 0)
                {
                    num = point.X - clientRectangle.Right + int_4 + 3;
                }
                if (int_4 > clientRectangle.Width)
                {
                    if (point.X > 3)
                    {
                        num = point.X - 3;
                    }
                    if (point.X + int_4 < clientRectangle.Width)
                    {
                        num = point.X - clientRectangle.Width + int_4 + 3;
                    }
                }
                else if (point.X < clientRectangle.Left)
                {
                    num = point.X - 3 - clientRectangle.Left;
                }
                if (point.Y > clientRectangle.Bottom - int_5 + 3)
                {
                    if (clientRectangle.Bottom - int_5 + 3 > 0)
                    {
                        num2 = point.Y - clientRectangle.Bottom + int_5 + 3;
                    }
                    else if (point.Y + int_5 < clientRectangle.Top)
                    {
                        num2 = point.Y - clientRectangle.Bottom + int_5 + 3;
                    }
                ...
                if (int_5 > clientRectangle.Bottom)
                {
                    if (point.Y > 3)
                    {
                        num2 = point.Y - 3;
                    }
                    if (point.Y + int_5 < clientRectangle.Bottom)
                    {
                        num2 = point.Y - clientRectangle.Bottom + int_5 + 3;
                    }
                }
                ...
                {
                    num2 = point.Y - 3 - clientRectangle.Top;
                }
                if (num != 0 || num2 != 0)
                {
                    bool_9 = true;
                    Point point_ = new Point(num - base.AutoScrollPosition.X, num2 - base.AutoScrollPosition.Y);
                    SetAutoScrollPosition(point_);
                    result = true;
                }
            }

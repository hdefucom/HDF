...
{
	[ComVisible(false)]
	public class GClass611 : GInterface50
	{
		private static readonly GClass639[] gclass639_0 = new GClass639[0];

		private GClass646 gclass646_0 = new GClass646();

		protected internal virtual GClass646 vmethod_0()
		{
			return gclass646_0;
		}
		...
		public virtual GClass645 imethod_1(GClass616 gclass616_0, Hashtable hashtable_0)
		{
			...
			if (hashtable_0 != null && hashtable_0.ContainsKey(GClass633.gclass633_1))
			{
				...
				gClass = gclass646_0.method_1(gclass679_);
				gclass639_ = gclass639_0;
			}
			else
			{
				GClass663 gClass2 = new GClass665(gclass616_0.method_2()).vmethod_3(hashtable_0);
				gClass = gclass646_0.method_1(gClass2.method_0());
				gclass639_ = gClass2.method_1();
			}
			GClass645 gClass3 = new GClass645(gClass.method_1(), gClass.method_0(), gclass639_, BarcodeFormat.barcodeFormat_0);
		...
		private static GClass679 smethod_0(GClass679 gclass679_0)
		{
			...
			int j;
			for (j = i; j < num3 && gclass679_0.method_3(j, j); j++)
			{
			}
			if (j == num3)
			{
			...
			int num4 = j - i;
			int num5 = num2 - 1;
			while (num5 >= 0 && !gclass679_0.method_3(num5, i))
			{
				num5--;
			}
			if (num5 < 0)

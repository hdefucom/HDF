...
namespace DCSoft.FriedmanCurveChart
{
	...
	///       </summary>
	[ComVisible(false)]
	public class FCdlgEditSingleValueWithoutTime : Form
	{
		...
		///       初始化对象
		///       </summary>
		public FCdlgEditSingleValueWithoutTime()
		{
			InitializeComponent();
			base.DialogResult = DialogResult.Cancel;
		}

		private void FCdlgEditSingleValueWithoutTime_Load(object sender, EventArgs e)
		{
		}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.FriedmanCurveChart.FCdlgEditSingleValueWithoutTime));
			...
			base.Load += new System.EventHandler(FCdlgEditSingleValueWithoutTime_Load);
			ResumeLayout(false);
			PerformLayout();
		}
	}

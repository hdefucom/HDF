...
namespace DCSoft.FriedmanCurveChart
{
	...
	[CompilerGenerated]
	[DebuggerNonUserCode]
	internal class DCFriedmanCurveStrings
	{
		...
		internal static ResourceManager ResourceManager
		{
			get
			{
				...
				{
					ResourceManager resourceManager = resourceManager_0 = new ResourceManager("DCSoft.FriedmanCurveChart.DCFriedmanCurveStrings", typeof(DCFriedmanCurveStrings).Assembly);
				}
		...
		///         查找类似 时间区域 的本地化字符串。
		///       </summary>
		internal static string FriedmanCurveZone => ResourceManager.GetString("FriedmanCurveZone", cultureInfo_0);
		...
		internal DCFriedmanCurveStrings()
		{
		}
	}
}

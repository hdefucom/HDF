...
namespace DCSoft.FriedmanCurveChart
{
	...
	///       </summary>
	[ComVisible(false)]
	public class FCdlgSQLText : Form
	{
		[ComVisible(false)]
		public class GClass19 : UITypeEditor
		{
			...
			{
				using (FCdlgSQLText fCdlgSQLText = new FCdlgSQLText())
				{
					fCdlgSQLText.InputText = Convert.ToString(value);
					if (fCdlgSQLText.ShowDialog() == DialogResult.OK)
					{
						return fCdlgSQLText.InputText;
					}
				}
				return value;
			}

...
namespace DCSoft.FriedmanCurveChart
{
	...
	///       </summary>
	[ComVisible(false)]
	public class FCdlgEditSingleValue : Form
	{
		...
		private FCDateTimePrecisionMode fcdateTimePrecisionMode_0 = FCDateTimePrecisionMode.Second;
		...
		///       输入时间的精度
		///       </summary>
		[DefaultValue(FCDateTimePrecisionMode.Second)]
		...
		public DateTime InputTime
		{
			get
			{
				return Class163.smethod_1(dateTimePicker1.Value, InputTimePrecision);
			}
			set
			{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DCSoft.FriedmanCurveChart.FCdlgEditSingleValue));
			...
			base.Load += new System.EventHandler(FCdlgEditSingleValue_Load);
			ResumeLayout(false);
			PerformLayout();
		}
		...
		///       初始化对象
		///       </summary>
		public FCdlgEditSingleValue()
		{
			InitializeComponent();
			base.DialogResult = DialogResult.Cancel;
		}

		private void FCdlgEditSingleValue_Load(object sender, EventArgs e)
		{
			dateTimePicker1.CustomFormat = Class163.smethod_0(InputTimePrecision);
			txtValue.Focus();
		}
